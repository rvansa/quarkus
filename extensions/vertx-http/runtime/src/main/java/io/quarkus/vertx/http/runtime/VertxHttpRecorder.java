...
public class VertxHttpRecorder {
    ...
    private static class ManagementVerticle extends CheckpointableVerticle {
        ...
        public void stop(Promise<Void> stopPromise) throws Exception {
            ...
            servers.forEach(s -> s.close(event -> {
    ...
    private static CompletableFuture<HttpServer> initializeManagementInterface(
            ...
            ManagementConfig managementConfig,
            LaunchMode launchMode,
            List<String> websocketSubProtocols, TlsConfigurationRegistry registry,
    ...
    private static void doServerStart(
        ...
        try {
            ...
            String managementDeploymentId = managementFuture.get();
            ...
            closeTask = new Runnable() {
                ...
                public synchronized void run() {
                    ...
                    if (closeTask == this) {
                        ...
                        if (mainWebDeploymentId != null) {
                            try {
                                vertx.undeploy(mainWebDeploymentId, handler);
                            } catch (Exception e) {
                        ...
                        try {
                            ...
                            vertx.undeploy(managementDeploymentId, handler);
                        } catch (Exception e) {
                            if (e instanceof RejectedExecutionException) {
                                // Shutting down
